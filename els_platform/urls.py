...
urlpatterns = [
    ...
    path('articles/index-vs-stock/', views.article_course_lesson, {'slug': 'index-vs-stock'}, name='article_course_07'),
    path('articles/no-knock-in/', views.article_course_lesson, {'slug': 'no-knock-in'}, name='article_course_08'),
    path('articles/lizard/', views.article_course_lesson, {'slug': 'lizard'}, name='article_course_09'),
    path('articles/monthly-payment/', views.article_course_lesson, {'slug': 'monthly-payment'}, name='article_course_10'),
    path('articles/more-evaluation-dates/', views.article_course_lesson, {'slug': 'more-evaluation-dates'}, name='article_course_11'),
    path('articles/read-prospectus/', views.article_course_lesson, {'slug': 'read-prospectus'}, name='article_course_12'),
    path('articles/four-before-yield/', views.article_course_lesson, {'slug': 'four-before-yield'}, name='article_course_13'),
    path('articles/knock-in-45-vs-35/', views.article_course_lesson, {'slug': 'knock-in-45-vs-35'}, name='article_course_14'),
    path('articles/high-yield-conditions/', views.article_course_lesson, {'slug': 'high-yield-conditions'}, name='article_course_15'),
    path('articles/near-52week-high/', views.article_course_lesson, {'slug': 'near-52week-high'}, name='article_course_16'),
    path('articles/more-assets-diversification/', views.article_course_lesson, {'slug': 'more-assets-diversification'}, name='article_course_17'),
    path('articles/backtest-loss-probability/', views.article_course_lesson, {'slug': 'backtest-loss-probability'}, name='article_course_18'),
    path('articles/first-redemption-failed/', views.article_course_lesson, {'slug': 'first-redemption-failed'}, name='article_course_19'),
    path('articles/recover-after-knock-in/', views.article_course_lesson, {'slug': 'recover-after-knock-in'}, name='article_course_20'),
    path('articles/maturity-profit-loss/', views.article_course_lesson, {'slug': 'maturity-profit-loss'}, name='article_course_21'),
    path('articles/portfolio-overlap/', views.article_course_lesson, {'slug': 'portfolio-overlap'}, name='article_course_22'),
    path('articles/track-evaluation-dates/', views.article_course_lesson, {'slug': 'track-evaluation-dates'}, name='article_course_23'),
    path('articles/early-termination/', views.article_course_lesson, {'slug': 'early-termination'}, name='article_course_24'),
    path('articles/ten-year-score/', views.article_course_lesson, {'slug': 'ten-year-score'}, name='article_course_25'),
    path('articles/hscei-2021/', views.article_course_lesson, {'slug': 'hscei-2021'}, name='article_course_26'),
    path('articles/why-stock-loss-higher/', views.article_course_lesson, {'slug': 'why-stock-loss-higher'}, name='article_course_27'),
    path('articles/conditions-over-ten-years/', views.article_course_lesson, {'slug': 'conditions-over-ten-years'}, name='article_course_28'),
    path('articles/els-tax/', views.article_course_lesson, {'slug': 'els-tax'}, name='article_course_29'),
    path('articles/issuer-credit-risk/', views.article_course_lesson, {'slug': 'issuer-credit-risk'}, name='article_course_30'),
