...
TICKER_MAP = {
    ...
    "LG화학": "051910.KS",
    "POSCO홀딩스": "005490.KS",
    # ⚠ "KT"(030200)와 "KT&G"(033780)는 **다른 회사**다. 이름이 겹쳐 보이지만
    #   통신사와 담배회사고 주가대도 5만원대 vs 18만원대로 3배 넘게 벌어진다.
    #   resolve_ticker는 부분일치가 아니라 **완전일치**로만 찾으므로("KT&G" != "KT")
    #   이 항목이 KT&G를 잘못 집는 일은 없다 — 그 성질에 기대고 있으니
    #   매칭을 부분일치로 바꾸려거든 이 둘부터 확인할 것.
    "KT": "030200.KS",
    "삼성중공업": "010140.KS",
    # ── 해외 종목 ──
