...
#    나온다 — 엑셀을 근거로 쓰지 말 것. 당시 v7 기준은 5,392건이었고,
#    2026-08-11 v8 전환 후 현행은 5,544건이다.)
...
RADAR_V8_YLD_PCT = 0.40   # ④ 쿠폰 ≥ 같은 그룹 분포 하위 40% 값 (= 상위 60%)
# 2026-09-03: ④를 0.30→0.40 상향(수익률 튜닝 검토). 저쿠폰 상품만 더 걸러져
#   손실 24→22·정상상환 99.57% 유지, 종목형 쿠폰 17.25→18.32%(+1.1%p),
#   공급 5,544→5,164(주당 9.97). 2022년 이후 표본 부트스트랩상 안전성 악화 없음
#   (손실·정상상환 신뢰구간이 0.30과 완전히 겹침). EC2 yield_levers.py 실측.
